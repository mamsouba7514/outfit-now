...
import { DashAgentType } from '@prisma/client';
...
export async function seedAgents(prisma: PrismaClient) {
  const allAgents = [
    ...
    // Designer sub-agents
    {
      ...
      type: DashAgentType.HUMAN,
      parentId: 'agent-senior-designer',
    },
    {
      id: 'agent-brand',
      name: 'Brand Designer',
    ...
    // Influencer sub-agents
    {
      ...
      type: DashAgentType.CLAUDE,
      parentId: 'agent-senior-influencer',
    },
    {
      id: 'agent-community',
    ...
    // Legal sub-agents
    {
      ...
      type: DashAgentType.HUMAN,
      parentId: 'agent-senior-juridique',
    },
    {
      id: 'agent-compliance',
